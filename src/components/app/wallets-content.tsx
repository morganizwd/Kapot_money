...
export function WalletsContent({ book, wallets, categories }: { book: FinanceBook; wallets: WalletBalance[]; categories: Category[] }) {
  const [sheet, setSheet] = useState<"wallet" | "category" | null>(null);
